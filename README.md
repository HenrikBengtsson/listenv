...
<a href="https://CRAN.R-project.org/web/checks/check_results_listenv.html"><img border="0" src="https://www.r-pkg.org/badges/version/listenv" alt="CRAN check status"/></a> <a href="https://github.com/HenrikBengtsson/listenv/actions?query=workflow%3AR-CMD-check"><img border="0" src="https://github.com/HenrikBengtsson/listenv/workflows/R-CMD-check/badge.svg?branch=develop" alt="Build status"/></a>  <a href="https://ci.appveyor.com/project/HenrikBengtsson/listenv"><img border="0" src="https://ci.appveyor.com/api/projects/status/github/HenrikBengtsson/listenv?svg=true" alt="Build status"/></a> <a href="https://codecov.io/gh/HenrikBengtsson/listenv"><img border="0" src="https://codecov.io/gh/HenrikBengtsson/listenv/branch/develop/graph/badge.svg" alt="Coverage Status"/></a> 
</div>
